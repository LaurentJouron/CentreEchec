...
class BaseDate(BaseView):
    ...
    def display_format_error(self):
        print("Invalid date format. Please use ddmmaaaa format.")
        ...
        while True:
            ...
            if self.validate_date(answer):
                if start_date is not None:
                    ...
                    end_datetime = datetime.strptime(answer, "%d%m%Y")
    ...
    def is_date_valid(self, date_code):
        try:
